...
public static class LootGenerator
{
    ...
    {
        // Determine item type (70% Gold, 10% Equipment, 20% Consumable)
        ...
        // Generate rarity and base stats
        ItemRarity rarity = type == ItemType.Gold ? ItemRarity.Common : GenerateRarity();
